...
export default function TicketPage() {
  ...
  // mover mesa UI (lo dejamos, pero los botones los puedes deshabilitar en V1)
  ...
  // (V1: si quieres, deja esto solo para manager, pero no es necesario para cobrar)
  ...
  // - RENTAL: MANAGER cobra si CHECKOUT
  // - RENTAL: SELLER puede cobrar si OPEN (auto-cierra backend) o CHECKOUT
  const canCheckout =
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#060606", color: "#fff", padding: 20 }}>
      ...
      <div style={{ marginTop: 14, background: "#0d0d0d", border: "1px solid #222", borderRadius: 14, padding: 14 }}>
        ...
        {/* ✅ Acciones: COBRAR visible para todos (SELLER incluido) */}
        <div style={{ marginTop: 12, display: "flex", gap: 10, flexWrap: "wrap" }}>
          {/* V1: deja estos botones visibles solo manager */}
          {isManager && canMove && (
